...
HD_PWD='/home/rehan/MERL/FPGA_EMU/GPIO/GPIO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_controller.tcl
