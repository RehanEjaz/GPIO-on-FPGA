...
HD_PWD='/home/rehan/MERL/FPGA_EMU/GPIO/GPIO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gpio_controller.tcl -notrace
